...
import main4 from "../../../src/main4.png"
...
const Home = () => {
  return (
    <>
        ...
        <div className="div-main">
          ...
          <div className="main-right">
            <h1 className="main-h1">
              <span className="h1-span">For every student,</span><br />
              <span className="h1-span">every classroom.</span><br />
              <span className="h1-span">Real results.</span>
            </h1>
            <p className="main-p">
      ...
      <div className="main4">
          <div className="main4-div1">
              <div className="main4-imgdiv">
                  <img className="main4-img" src={main4} alt="" />
              </div>
          </div>
      ...
      <div className="main5">
        <h2 className="main5-h2">Join Khan Academy today</h2>
      ...
      <div className="main6">
        ...
        <div className="sup2">
          <div className="sup2imgdiv">
            <img className="sup2img" alt="Bank of America" src="https://cdn.kastatic.org/images/supporters-logos/bank-of-america-gray@2x.png"></img>
          </div>
          <div className="sup2imgdiv">
            <img className="sup2img" alt="AT&T" src="https://cdn.kastatic.org/images/supporters-logos/att-gray@2x.png"></img>
          </div>
          <div className="sup2imgdiv">
            <img className="sup2img" alt="Google.org" src="https://cdn.kastatic.org/images/supporters-logos/google-gray@2x.png"></img>
          </div>
          <div className="sup2imgdiv">
            <img className="sup2img" alt="Novartis" src="https://cdn.kastatic.org/images/supporters-logos/novartis-gray@2x.png"></img>
          </div>
          <div className="sup2imgdiv">
            <img className="sup2img" alt="Fastly" src="https://cdn.kastatic.org/images/supporters-logos/fastly-gray@2x.png"></img>
          </div>
          <div className="sup2imgdiv">
            <img className="sup2img" alt="General Motors" src="https://cdn.kastatic.org/images/supporters-logos/gm-gray@2x.png"></img>
          </div>
          <div className="sup2imgdiv">
            <img className="sup2img" alt="Adobe" src="https://cdn.kastatic.org/images/supporters-logos/adobe-gray@2x.png"></img>
          </div>
        </div>
      </div>
      </div>
